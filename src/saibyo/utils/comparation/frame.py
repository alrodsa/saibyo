...
def put_text(
    ...
    # Obtener tamaño de ambas líneas
    ...
    match position:
        ...
        case "bottom_left":
            ...
            y = video_metadata.height - video_metadata.height // 20 - text_height_total + h1
        case "bottom_right":
    ...
    # Dibujar líneas
    cv2.putText(frame, line1, (x, y), font, font_size, (255, 255, 255), thickness, cv2.LINE_AA)
    cv2.putText(frame, line2, (x, y + h2 + line_spacing), font, font_size, (255, 255, 255), thickness, cv2.LINE_AA)
